...
void all_word_frequency(char *, string[], int[]);
 ...
 ********************************************************************/
void add_unique_word(int &index, string current_word, string word[], int count[])
{
 ...
 ********************************************************************/
void all_word_frequency(char * text, string word[], int count[])
{
