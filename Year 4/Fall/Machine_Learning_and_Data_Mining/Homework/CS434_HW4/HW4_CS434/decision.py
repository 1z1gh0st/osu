# We are going to cheat a little here and use a package for the dataset and 
# decision trees. Thats why this isn't considered an implementation question.
...
for m in range(M):
  ...
  ###################################################
  # TODO MODIFY IN HERE TO DECREASE CORRELATION
  ###################################################
  X_data = X_train
  y_data = y_train
